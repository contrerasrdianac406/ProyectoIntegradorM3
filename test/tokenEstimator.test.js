 ...
 describe("estimateTokens", () => { 
    ...
    describe("estimateContentsTokens", () => { 
        it("suma los tokens de todos los mensajes del array", () => { 
            const contents = [ { role: "user", parts: [{ text: "hola" }] }, // 1 
            // token { role: "model", parts: [{ text: "hola mundo" }] } // 3 tokens ]; expect(estimateContentsTokens(contents)).toBe(4); }); });